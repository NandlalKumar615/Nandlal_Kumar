...
const Footer =()=>{
    ...
    const submitHandler = (event) =>{
        ...
        const currentDate = dateTime.getDate()+'/'+(dateTime.getMonth()+1)+'/'+dateTime.getFullYear();
        const currentTime = dateTime.getHours()+':'+dateTime.getMinutes()+':'+dateTime.getSeconds();
        ...
        // setSubmitMessage("Thanks! will connect soon.");
            ...
            <div className="footer-Container">
                <form className="footer-Form" onSubmit={submitHandler}>
                    <div className="footer-Form-Group">
                        <input className="footer-Form-Input" type="text" placeholder="Name" ref={formName} required/>
                        <label className="footer-Form-Label" htmlFor="Name">Name</label>
                    </div>
                    <div className="footer-Form-Group">
                        <input className="footer-Form-Input" type="email" placeholder="Email ID" ref={formEmail} required/>
                        <label className="footer-Form-Label" htmlFor="Email">Email ID</label>
                    </div>
                    <div className="footer-Form-Group">
                        <input className="footer-Form-Input" type="text" placeholder="Phone No." ref={formPhone}/>
                        <label className="footer-Form-Label" htmlFor="Phone">Phone No.</label>
                    </div>
                    <div className="footer-Form-Group">
                        <textarea className="footer-Form-Input" type="text" placeholder="Message" rows={3} ref={formMessage}/>
                        <label className="footer-Form-Label" htmlFor="Message">Message</label>
                    </div>
